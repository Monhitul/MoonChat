(function(){
    ...
    UM.registerWidget('emotion',{
        ...
        tpl: "<link type=\"text/css\" rel=\"stylesheet\" href=\"<%=emotion_url%>emotion.css\">" +
            ...
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab0\" hideFocus=\"true\" class=\"edui-tab-text\"></a></li>" +
            "</ul>" +
        ...
        sourceData: {
            emotion: {
                tabNum:1, //切换面板数量
                SmilmgName:{ 'edui-emotion-Jtab0':['i_f', 50] }, //图片前缀名
                imageFolders:{ 'edui-emotion-Jtab0':'face/'}, //图片对应文件夹路径
                imageCss:{'edui-emotion-Jtab0':'pp'}, //图片css类名
                imageCssOffset:{'edui-emotion-Jtab0':25}, //图片偏移
                SmileyInfor:{
                    'edui-emotion-Jtab0':['微笑', '亲吻', '调皮', '惊讶', '耍酷', '发火', '害羞', '汗水', '大哭', '得意', '鄙视', '困', '夸奖', '晕倒', '疑问', '媒婆', '狂吐', '青蛙', '发愁', '亲吻', '', '爱心', '心碎', '玫瑰', '礼物', '哭', '奸笑', '可爱', '得意', '呲牙', '暴汗', '楚楚可怜', '困', '哭', '生气', '惊讶', '口水', '彩虹', '夜空', '太阳', '钱钱', '灯泡', '咖啡', '蛋糕', '音乐', '爱', '胜利', '赞', '鄙视', 'OK']
                }
            }
        },
